...
namespace TCP_ROBOT
{
	...
	*/
	...
	void RobotBase::slotUpdateModel(WORKANDHOLE workAndHole)
	{

	}

	void RobotBase::slotReplaceModelByPath(SHAPESTRUCT shapeStruct)
	{
	...
	void RobotBase::slotChangPreviewColor(SHAPESTRUCT shapeStruct)
	{
		// 修改颜色
	...
	void RobotBase::slotChangedPreviewScale(SHAPESTRUCT shapeStruct)
	{
		slotReplaceModelByPath(shapeStruct);
	}

	void RobotBase::slotChangedPreviewRotation(SHAPESTRUCT shapeStruct)
	{
		slotReplaceModelByPath(shapeStruct);
	}

	void RobotBase::slotChangedPreviewTranslation(SHAPESTRUCT shapeStruct)
	{
		// 修改位置
		slotReplaceModelByPath(shapeStruct);
	}

	void RobotBase::removePreview(SHAPESTRUCT shapeStruct)
	{
		RemovePreview(m_mapPreviewData[shapeStruct.ShapeName]);
	}

	void RobotBase::removeAllPreview()
	{
	...
	void RobotBase::RemovePreview(ADDROBOTDATA addRobotData)
	{
